    ...
    <x-slot name="header">
        <div>
            ...
            <p class="mt-1 text-sm text-slate-600">
                Accede a tu matrícula, horario y catálogos en modo consulta
            </p>
        </div>
    </x-slot>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div>
            <div class="section-header">
                <h3 class="text-xl font-serif font-bold text-university-900">Módulos del Estudiante</h3>
                <p class="text-sm text-slate-600 mt-1">Consulta catálogos y gestiona tu matrícula</p>
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">

                <!-- Auto-Matrícula -->
                <a href="{{ route('mi.matricular') }}"
                   class="group relative bg-white rounded-xl shadow-sm border-2 border-slate-200 hover:border-university-500 hover:shadow-lg transition-all duration-300 overflow-hidden">
                    ...
                    <div class="relative p-6">
                        ...
                        <h4 class="text-lg font-semibold text-slate-900 mb-2 group-hover:text-university-700">Auto-Matrícula</h4>
                        <p class="text-sm text-slate-600">Inscríbete en grupos disponibles según tu plan</p>
                ...
                <a href="{{ route('mi.horario') }}"
                   class="group relative bg-white rounded-xl shadow-sm border-2 border-slate-200 hover:border-university-500 hover:shadow-lg transition-all duration-300 overflow-hidden">
                    ...
                    <div class="relative p-6">
                        ...
                        <h4 class="text-lg font-semibold text-slate-900 mb-2 group-hover:text-university-700">Mi Horario</h4>
                        <p class="text-sm text-slate-600">Consulta tu horario de clases por periodos</p>
                        <div class="mt-4 flex items-center text-university-700 text-sm font-medium">
                            <span>Ver</span>
                            <svg class="w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                ...
                <a href="{{ route('mi.materias.index') }}"
                   class="group relative bg-white rounded-xl shadow-sm border-2 border-slate-200 hover:border-university-500 hover:shadow-lg transition-all duration-300 overflow-hidden">
                    ...
                    <div class="relative p-6">
                        ...
                        <p class="text-sm text-slate-600">Buscar y consultar materias (solo lectura)</p>
                        <div class="mt-4 flex items-center text-university-700 text-sm font-medium">
                            <span>Consultar</span>
                            <svg class="w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                ...
                <!-- Planes de Estudio (solo lectura) -->
                <a href="{{ route('mi.planes.index') }}"
                   class="group relative bg-white rounded-xl shadow-sm border-2 border-slate-200 hover:border-university-500 hover:shadow-lg transition-all duration-300 overflow-hidden">
                    ...
                    <div class="relative p-6">
                        ...
                        <p class="text-sm text-slate-600">Consultar planes y sus materias (solo lectura)</p>
                        <div class="mt-4 flex items-center text-university-700 text-sm font-medium">
                            <span>Consultar</span>
                            <svg class="w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                ...
                <a href="{{ route('mi.grupos.index') }}"
                   class="group relative bg-white rounded-xl shadow-sm border-2 border-slate-200 hover:border-university-500 hover:shadow-lg transition-all duration-300 overflow-hidden">
                    ...
                    <div class="relative p-6">
                        ...
                        <p class="text-sm text-slate-600">Buscar oferta académica y cupos (solo lectura)</p>
                        <div class="mt-4 flex items-center text-university-700 text-sm font-medium">
                            <span>Consultar</span>
                            <svg class="w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                ...
                <a href="{{ route('profile.edit') }}"
                   class="group relative bg-white rounded-xl shadow-sm border-2 border-slate-200 hover:border-university-500 hover:shadow-lg transition-all duration-300 overflow-hidden">
                    <div class="absolute top-0 right-0 w-32 h-32 bg-university-50 rounded-full -mr-16 -mt-16 group-hover:bg-university-100 transition-colors"></div>
                    <div class="relative p-6">
                        <div class="w-12 h-12 bg-slate-100 rounded-lg flex items-center justify-center mb-4 group-hover:bg-slate-700 transition-colors">
                            <svg class="w-6 h-6 text-slate-700 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                      d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                            </svg>
                        </div>
                        <h4 class="text-lg font-semibold text-slate-900 mb-2 group-hover:text-university-700">Mi Perfil</h4>
                        <p class="text-sm text-slate-600">Ver tu información personal</p>
                        <div class="mt-4 flex items-center text-university-700 text-sm font-medium">
                            <span>Ver</span>
                            <svg class="w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
