    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded shadow">
                <form method="POST" action="{{ route('docentes.store') }}" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    @csrf
                    ...
                    <div>
                        ...
                        <input name="apellido" value="{{ old('apellido') }}" required
                               class="w-full rounded border-gray-300 dark:bg-gray-900 dark:border-gray-700">
                    </div>
                    ...
                    <div>
                        ...
                        <input name="especialidad" value="{{ old('especialidad') }}"
                               class="w-full rounded border-gray-300 dark:bg-gray-900 dark:border-gray-700">
                    </div>
                    ...
                    <div class="md:col-span-2 border-t dark:border-gray-700 pt-4 mt-2">
                        <h3 class="font-semibold text-gray-900 dark:text-gray-100 mb-3">Credenciales</h3>
                    </div>
